                        ...
                        <div class="modal-dialog " title="">
                            <div class="modal-content">
                                ...
                                <div class="modal-header">
                                    <h4 class="modal-title text-center "><?php echo "Apiário " . $linha['LOCAL']; ?></h4>
                                </div>
        ...
        <div class="row fixed-bottom  linhacad ">
            ...
            <div class="col-md-3 offset-1 ">
                ...
                <form class="d-flex" action="apiario.php" method="POST">
                    ...
                    <button type="button" class="btn btn-primary btn-sm " data-bs-toggle="modal" data-bs-target="#pesquisa">Pesquisa</button>
                </form>
            </div>
