            ...
            <div class="row linhaTAB  dt-responsive table-responsive overflow-auto">
                ...
                <table class=" table  overflow-auto" style="width:100%; ">
                    ...
                    <tbody>
                                ...
                                <div class="modal-dialog img-responsive" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer justify-content-center img-responsive ">
                                            <a href='rainha.php'><button type="button"
                                                    class="btn btn-secondary text-center " data-dismiss="modal">
                                                    Cancelar
                                                </button>
                                            </a>
                                            <a href="desativa/rainha_off.php?COD_RAINHA=<?php echo $id ?>"><button
                                ...
                                <div class="modal-dialog img-responsive" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body bg-light ">
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <form class="form-group " method="post" name="cadAPIARIO"
                                                    action="valida_cad/SALVARcad_rainha.php">
                                                    ...
                                                    <br>
                                                    <select class="form-control" name="origem" class="situacao"
                                                        width="auto">
                                                        <option value="Sem informação" selected> Informe a origem da raínha
                                                        </option>
                                        ...
                                        <div class="modal-footer justify-content-center img-responsive ">
                                            ...
                                            <a href="desativa/COLMEIA_off.php?COD_RAINHA=<?php echo $id ?>"><button
                        ...
                        <div class="modal   " id="detalhes_AP<?php echo $linha['COD_RAINHA']; ?>" tabindex="-1"
                                    ...
                                    <!--inicio cabeçalho do modal-->
                                        <div class="modal-header bg-dark text-white ">
                                            <h5 class="modal-title  ">
                                                <?php echo "Raínha: " . $linha['DESC_RAINHA']; ?>
                                            </h5>
                                            <a href="rainha.php"> <button type="button" class="close" data-dismiss="modal"
                                                    aria-label="Fechar">
                ...
                <div class="modal-body">
                    ...
                    <div class="col-md-12">
                        ...
                        <form class="form-group " method="post" name="cadAPIARIO"
                            ...
                            <input type="text" class="form-control  " required maxlength="30" name="DESCRICAO_RAINHA"
                                placeholder="Descrição da Raínha " onfocus="this.value='';" />
