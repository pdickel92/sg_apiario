...
<body>
  ...
  <nav class="navBar">
    <div class="col-6" style="border-radius: 10px;">
      ...
      <span><b>Acompanhe nossas redes sociais! </b></span>
      <a href="https://www.instagram.com" name="Instagram" class="ms-auto" target="_blank"><img src="img/insta.jpg"
          style="padding-right:10px; width:37px; height:37px;"></a>
      <a href="https://www.facebook.com" name="Facebook" class="ms-auto" target="_blank"><img src="img/face.jpeg"
          width="37px" height="35px"></a>
      <a href="https://www.twitter.com" name="Twitter" class="ms-auto" target="_blank"><img src="img/twitter.jpeg"
          width="37px" height="35px"></a>
      <a href="https://www.youtube.com" name="Youtube" class="ms-auto" target="_blank"><img src="img/youtube.jpeg"
          width="37px" height="35px"></a>
    </div>
    </div>
    </ul>
  ...
  <form class="formulario" method="post" action="verifica_login.php">
  ...
  <div class="tempo">
          ...
          <div class="booked-wzs-250-175-data">
            ...
            <div class="booked-wzs-250-175-right">
              ...
              <div class="booked-wzs-250-175-info">
                ...
                <div class="booked-wzs-left"> <span class="booked-wzs-bottom-l">Ver Previsão de 7 Dias</span>
                </div>
              </div>
            </div>
          </div>
    ...
    <script type="text/javascript"> var css_file = document.createElement("link"); var widgetUrl = location.href; css_file.setAttribute("rel", "stylesheet"); css_file.setAttribute("type", "text/css");
      css_file.setAttribute("href", 'https://s.bookcdn.com/css/w/booked-wzs-widget-275.css?v=0.0.1'); document.getElementsByTagName("head")[0].appendChild(css_file); function setWidgetData_31359(data) {
  ...
  <footer class="rodape">
    <p>Author: Hege Refsnes<br>
      <center><a href="mailto:hege@example.com">Gestão de Apiários</a>
    </p>
    </center><br><br><br>
  </footer>
</body>
