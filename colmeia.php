...
<body>
            ...
            <div class="col-12  mx-auto text-center img-responsive ">
                ...
                <div class="col-4" style="margin-left:-20px;" >
                    ...
                    <button type="button" class="btn btn-success btn-sm btcad" data-bs-toggle="modal" data-bs-target="#CadApiarioModal" >                    
                        Adicionar Colméia <img src='img/add.png' width='22px' height='28px' class="img-responsive">
                    </button>
                    <button type="button" class="btn btn-dark btn-sm btcad" data-bs-toggle="modal" data-bs-target="#CadFloradaModal" >                    
                        Inativas <img src='img/lupa.png' width='22px' height='28px' class="img-responsive">
                    </button>
                </div>
                    <div class="col-8">
    ...
    <div class="container overflow-auto " style="max-height: 300px; min-height:300px; margin-top:5px; background: rgba(255, 255, 255, 0.4); border-radius: 20px;">
                        ...
                        <tbody>
                            <tr class="table-striped ">
                                ...
                                while ($linha = mysqli_fetch_array($resultado)) { ?>
                                    ...
                                    <td>
                                        <?php echo $linha['DESC_COLMEIA']; ?>
                                    </td>
                                    <td>
                                        <?php echo $linha['CAIXA']; ?>
                                    </td>
                                    ...
                                    <td>
                                        <button type="button" data-bs-toggle="modal" class="btn btn-sm btn-link"
                                            data-bs-target="#tarefas_AP<?php echo $linha['COD_COLMEIA']; ?>">
                                            <img src='img/tarefas.png' width='22px' height='22px'>
                                        </button>
                                        <button type="button" data-bs-toggle="modal" class="btn btn-sm btn-link"
                                            data-bs-target="#IOT_AP<?php echo $linha['COD_COLMEIA']; ?>">
                                            <img src='img/iot.png' width='22px' height='22px'>
                                        </button>
                                        <button type="button" data-bs-toggle="modal" class="btn btn-sm btn-link"
                                            data-bs-target="#colmeia_AP<?php echo $linha['COD_COLMEIA']; ?>">
                                ...
                                <div class="modal" tabindex="-1" role="dialog"
                                    id="exclusao<?php echo $linha['COD_COLMEIA']; ?>">
                                    <div class="modal-dialog img-responsive" role="document">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-footer justify-content-center img-responsive ">
                                                <a href='colmeia.php'><button type="button"
                                                        class="btn btn-secondary text-center " data-dismiss="modal">
                                                        Cancelar
                                                    </button>
                                                </a>
                                                <a href="desativa/colmeia_off.php?COD_COLMEIA=<?php echo $id ?>"><button
                                ...
                                <div class="modal" tabindex="-1" role="dialog"
                                    id="Edicao<?php echo $linha['COD_COLMEIA']; ?>">
                                    <div class="modal-dialog img-responsive" role="document">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body bg-light ">
                                                ...
                                                <div class="col-md-12">
                                                    ...
                                                    <select class="form-control" name="caixa" width="auto">
                                                        ...
                                                        <option value="Caixa Núcleo de Captura"> Caixa Núcleo de Captura
                                                        </option>
                                                    </select>
                                                    ...
                                                    <select class="form-control" name="origem" width="auto">
                                                        <option value="Sem Informação" selected> Qual a origem do enxame?
                                                        </option>
                                                        <option value="Sem Informação"> Sem Informação</option>
                                                    ...
                                                    <select class="form-control" name="enxame" width="auto">
                                                        <option value="Sem Informação" selected> Qual a espécie do enxame?
                                                        </option>
                                                        <option value="Sem Informação"> Sem Informação</option>
                                                        <option value="Abelha-Africana"> Abelha-Africana</option>
                                                        <option value="Abelhas-Africanizadas">Abelhas-Africanizadas
                                                        </option>
                            ...
                            <div class="modal   " id="detalhes_AP<?php echo $linha['COD_COLMEIA']; ?>" tabindex="-1"
                                        ...
                                        <!--inicio cabeçalho do modal-->
                                            <div class="modal-header bg-dark text-white ">
                                                <h5 class="modal-title  ">
                                                    <?php echo "Colméia: " . $linha['DESC_COLMEIA']; ?>
                                                </h5>
                                                <a href="colmeia.php"> <button type="button" class="close"
                                            ...
                                            <div class="modal-body" style="height:380px;">
                                                <div class="container">
                                                    ...
                                                    AND CATEGORIA = 'Mel'";
                                                            ...
                                                            <img src="img/mel.png" width="45px"
                            ...
                            <div class="modal   " id="tarefas_AP<?php echo $linha['COD_COLMEIA']; ?>" tabindex="-1"
                                ...
                                <!--MODAL IOT COLMEIA --->
                            <div class="modal   " id="IOT_AP<?php echo $linha['COD_COLMEIA']; ?>" tabindex="-1"
                                aria-labelledby="#" aria-hidden="true">
                                <div class="modal-dialog   modal_CONS" title="">
                                    <div class="modal-content">
                                                    ...
                                                    <div class="row ">
                                                        <div class="col md-12 COL1 ">
                                                            ...
                                                            <iframe width="450" height="290"
                                                                ...
                                                                src="https://thingspeak.com/channels/1863160/charts/1?color=%23d62020&dynamic=true&results=60&type=line"></iframe>
                                                            <hr width="100%">
                                                            </hr>
        ...
        <div class="modal fade" id="CadApiarioModal" tabindex="-1" aria-labelledby="exampleModalLabel"
            aria-hidden="true">
            <div class="modal-dialog ">
                <div class="modal-content ">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="col-md-12">
                            <!--inicio formulario de cadastro-->
                            <form class="form-group " method="POST" name="cadCOLMEIA"
                                action="VALIDA_CAD/SALVARcad_COLMEIA.php">
                                <input type="text" class="form-control  " required maxlength="30"
                                    name="DESCRICAO_COLMEIA" placeholder="Descrição da Colméia "
                                    onfocus="this.value='';" />
                                <input type="hidden" name="STATUS" />
                                ...
                                <!------------------------------------------CAIXA------------------------------------------>
                                <select class="form-control" name="caixa" width="auto">
                                    <option value="Sem Informação" selected> Informe o tipo da caixa...</option>
                                    <option value="Sem Informação"> Sem Informação</option>
                                    <option value=" Caixa Langstroth"> Caixa Langstroth </option>
                                    <option value="Caíxa Lusitana"> Caixa Lusitana</option>
                                    <option value="Caixa Reversível"> Reversível</option>
                                ...
                                <!---SELECT ORIGEM---->
                                <select class="form-control" name="origem" width="auto">
                                    <option value="Sem Informação" selected> Qual a origem do enxame?</option>
                                    <option value="Sem Informação"> Sem Informação</option>
                                    <option value=" Comprada"> Comprada </option>
                                    <option value="Resgatada"> Resgatada</option>
                                    <option value="Caixa-Isca"> Caixa-Isca</option>
                                ...
                                <!--SELECT ENXAME-->
                                <select class="form-control" name="enxame" width="auto">
                                    <option value="Sem Informação" selected> Qual a espécie do enxame?</option>
                                    <option value="Sem Informação"> Sem Informação</option>
                                    <option value="Abelha-Africana"> Abelha-Africana</option>
                                ...
                                <select class="form-control" name="RAINHA" width="auto">
                                    <option value="" selected>Informe a raínha...</option>
                                    <option value="0" selected>Caixa sem raínha</option>
                                    <?php
                                    while ($dados = mysqli_fetch_assoc($result)) {
                                        ?>
                                        <option value="<?php echo $dados['COD_RAINHA'] ?>">
            ...
            <div class="modal-dialog modal-lg ">
                <div class="modal-content">
                    ...
                    <div class="modal-header bg-dark text-white ">
                        ...
                        <a href="apiario.php"> <button type="button" class="close" data-dismiss="modal"
                                aria-label="Fechar">
                                <span aria-hidden="true">&times;</span>
                            </button> </a>
                    </div>
