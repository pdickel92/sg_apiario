            ...
            <div class="col-12  mx-auto text-center img-responsive ">
                ...
                <form class="d-flex img-responsive dt-responsive ml-2" action="" method="get">
                    <button type="button" class="btn btn-dark btn-sm btcad" data-bs-toggle="modal"
                        ...
                        Adicionar Tarefa <img src='img/add.png' width='22px' height='22px'
                            class="img-responsive"></button>
                    <button type="button" class="btn  btn-dark btn-sm  btcad " data-bs-toggle="modal"
                        data-bs-target="#CadApiarioModal">
                        Inativos <img src='img/lupa.png' width='20px' height='20px' class="img-responsive"></button>
                    <!--Ver inativos--->
                                        ...
                                        <div class="modal-body bg-light ">
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <select class="form-control" name="origem" width="auto">
                                                    <option value="Sem Informação" selected> Selecione a origem do enxame
                                                    </option>
                                                    <option value="Sem Informação"> Sem Informação</option>
                                                ...
                                                <select class="form-control" name="enxame" width="auto">
                                                    <option value="Sem Informação" selected> Selecione a espécie do enxame
                                                    </option>
                                                    <option value="Sem Informação"> Sem Informação</option>
